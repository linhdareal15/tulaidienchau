...
<body>
    ...
    ?>
  <section>
        <h2 class="title">XE <span class="color"><?php if(isset($_SESSION['cate_name'])){
                    echo($_SESSION['cate_name']);    
                }
            ?> </span> </h2>
        ...
        <?php
            foreach($product as $item){
                ...
                echo('<div class="card">
                <div class="image">
                    <a href="detail.php?productId='.$item['id'].'"><img src="'.$item['image_url'].'" alt=""></a>
                    <h2>'.$item['name'].'</h2>
                </div>
                <div class="details">
                    <!--<div class="size">
                    ...
                    <a href="detail.php?productId='.$item['id'].'">XEM NGAY</a>
                </div>
            </div>');
            }
        ?>
